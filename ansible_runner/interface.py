...
def run(**kwargs):
    ...
    :param inventory: Overridees the inventory directory/file (supplied at ``private_data_dir/inventory``) with
      ...
      - Path to the inventory file in the ``private_data_dir/inventories`` directory.
        Takes in a string for the relative location to the hosts file within the ``private_data_dir/inventories`` directory.
